                    ...
                    @endisset
                          ...
                          <div class="col-lg-8 col-xl-9">
                            <div class="card">
                                ...
                                <a href="{{ URL::to('pickup_invoice/'.$value->id)}}" target="_blank" style="float:right"><i class="fa fa-print"></i> Print Invoice </a>
                                     <h5 class="card-title">চালান নাম্বার:{{$value->m_invoice_id}}</h5>
                                       <small>
                                              <p style="color:red">তারিখ  : 
                                              <!-- {{$merchandise[0]->created_at}} -->
                                        @php
                                        $startdate=strtotime($merchandise[0]->created_at);
