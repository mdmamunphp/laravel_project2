                            ...
                            <div class="card">
                                ...
                                <div class="form-group row">
                                         <form class="form-valide" action="{{ URL::to('pickup_agent_add/store/'.$value->id) }}" method="post">
                                           ...
                                           <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="val-email"  style="color:#cc66ff">মার্চেন্ট মোবাইল </label>
                                                <div class="col-lg-6">
                                           ...
                                           <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="val-email"  style="color:#cc66ff">Roll Star নাম  </label>
                                                <div class="col-lg-6">
                                                <small>
                                                <?php 
                                           ...
                                           <div class="form-group row">
                                             <label class="col-lg-4 col-form-label" for="val-skill"  style="color:#cc66ff">Roll Star যুক্ত করুন </label>
                                                <select class="form-control" id="val-skill" name="agent_id">
                                                    <option value="">Roll Star নির্বাচন করুন</option>
                                                    @isset($agent)
