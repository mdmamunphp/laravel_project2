                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Edit Delivery Product Details</h5>
                            ...
                            <form action="{{ url('store_daily_accounts')}}" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="total_p_amount" class="col-form-label">Customer Name</label>
                                    ...
                                    <div class="form-group">
                                        <label for="end_balance" class="col-form-label">End Balance </label>
