                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="card">
                            <div class="card-body" style="background: linear-gradient(to bottom, #ccff33 0%, #99ff99 100%);">
                                <h3 align="center" style="color:#4d004d"> পেমেন্ট বিস্তারিত</h3>
                            </div>
                        </div>
                            ...
                            <!--<div class="card">-->
                                <div class="card-body">
                                     ...
                                     @php
                                       ...
                                       মার্চেন্ট মূল্য    :{{$delivery_amount[0]->total_delivery_amount+$return_amount[0]->total_return_amount}}<br/>
                                       ...
                                       মার্চেন্ট নেট মূল্য :<?php
                                              ...
                                              {{$net_amount}}<br/>
                                       Rollexpress পেইড      : {{$value->rollexpress_paid}}
                                
                                  

                                              <br/>
                                      মার্চেন্ট গ্রহন      : {{$value->merchandise_recieved_roll}}<br/>
                                      Rollexpress বাকী       :{{$net_amount-$value->rollexpress_paid}}<br/>
