                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media align-items-center mb-4">
                                    <img class="mr-3" src="{{ asset('public/admin/merchandise/'.session('sess_user_images'))}}" width="80" height="80" alt="">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col">
                                        <div class="card card-profile text-center">                                           
                                            <a href="{{ url('merchandise_product/'.session('sess_user_id'))}}"class="btn btn-sm btn-warning">পার্সেল যুক্ত করুন</a>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="card card-profile text-center">                                           
                                            <a href="{{ url('merchandis_product_list')}}" class="btn btn-sm btn-warning">পন্যের তালিকা</a>
                                        </div>
                                    </div>   
                                     <div class="col">
                                        <div class="card card-profile text-center">                                           
                                            <a href="{{ url('merchandise_product_profit')}}" class="btn btn-sm btn-warning">হিসাব</a>
                                        </div>
                                    </div>       
                                </div>
