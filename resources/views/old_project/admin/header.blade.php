                            ...
                            <div class="drop-down animated fadeIn dropdown-menu">
                                ...
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{ asset('public/asset/images/avatar/2.jpg')}}" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{ asset('public/asset/images/avatar/3.jpg')}}" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{ asset('public/asset/images/avatar/4.jpg')}}" alt="">
                                                <div class="notification-content">
...
<!-- 
                        ...
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative"   data-toggle="dropdown">
                                ...
                                <img src="{{ asset('public/asset/images/user/1.png')}}" height="40" width="40" alt="">
                            </div>
