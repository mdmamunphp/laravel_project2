                ...
                <form action="{{ url('regiser_all_users')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="recipient-name" placeholder="লিখুন এজেন্ট এর নাম">
                        </div>
                        <!-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="phone" id="phone-name" placeholder="লিখুন এজেন্ট এর মোবাইল নাম্বার">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">এজেন্ট এর পাসওয়ার্ড:</label>
                            <input type="text" class="form-control" name="password" id="recipient-name" placeholder="লিখুন এজেন্ট এর পাসওয়ার্ড">
                        </div>
                      
                        <div class="form-group">
                            <label for="phone-text" class="col-form-label">এজেন্ট এর ঠিকানা:</label>
                            <input type="text" class="form-control" name="address" id="phone-name" placeholder="লিখুন এজেন্ট এর ঠিকানা">
                        </div>
                        <div class="form-group">
